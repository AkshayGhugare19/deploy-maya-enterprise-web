				...
				>
									...
									{cartDetail?.sale_price ? (
										<span>
											<span className="line-through-text me-2">
												£ {parseFloat((cartDetail?.productDetails[0]?.price).toFixed(2))}
											</span>
											£ {parseFloat((cartDetail?.sale_price).toFixed(2))}
										</span>
									) : (
										<span>£ {parseFloat((cartDetail?.productDetails[0]?.price).toFixed(2))}</span>
									)}
								</p>
							</div>
						</div>
					...
					{!cartDetail?.productDetail[0]?.subProduct?.length ? (
								...
								{cartDetail?.couponName && cartDetail?.sale_price ? (
									<span>
										<span className="line-through-text me-2">
											£{" "}
											{parseFloat(
												(cartDetail?.quantity * cartDetail?.productDetails[0]?.price).toFixed(2)
											)}
										</span>
										<span className="">
											£ {parseFloat((cartDetail?.quantity * cartDetail?.sale_price).toFixed(2))}
										</span>
									</span>
								) : (
									<span>
						...
						>
							...
							<div className="">
								£ {parseFloat((cartDetail?.quantity * cartDetail?.productDetails[0]?.price).toFixed(2))}
							</div>
						</div>
					)}
				</div>
