...
const EnquiryPaymentSummary = ({enquirySummaryDetails})=>{
    ...
    return(
        ...
        <p className="flex justify-between text-gray-600 mt-4">
            <span>Cart Amount</span> <span>{enquirySummaryDetails?enquirySummaryDetails[0]?.cartAmount:"0"}</span>
        </p>
        ...
        <p className="flex justify-between text-[#14967F] mt-4 font-bold text-lg">
            <span>Total to pay</span> <span>₹{enquirySummaryDetails?enquirySummaryDetails[0].totalCartAmount:"0"}</span>
        </p>
