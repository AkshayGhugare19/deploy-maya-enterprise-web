        ...
        <div className="flex flex-col gap-4 lg:flex-row">
            ...
            <div className='p-4'>
                <div className='w-full gap-4 lg:flex'>
                    <div className='w-[100%]'>
                        <div className='border flex justify-center rounded-md'>
                            <img className=" h-[350px]  w-full   rounded-md" src={selectedImage} alt="Ace Q10 Capsule" />
                        </div>
                ...
                <div className='flex flex-col gap-4 mt-4'>
                    <div id="introduction" className='bg-white shadow-md rounded-lg p-4'>
                    ...
                    <div id="uses" className='bg-white shadow-md rounded-lg p-4'>
                    ...
                    <div id="therapeutic-effects" className='bg-white shadow-md rounded-lg p-4'>
                    ...
                    <div id="interaction" className='bg-white shadow-md rounded-lg p-4'>
                    ...
                    <div id="more-information-about" className='bg-white shadow-md rounded-lg p-4'>
                    ...
                    <div id="how-to-consume" className='bg-white shadow-md rounded-lg p-4'>
                    ...
                    <div id="word-of-advice" className='bg-white shadow-md rounded-lg p-4'>
